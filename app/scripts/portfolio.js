...
$(document).ready(function(){
    $('.bloc-jams').click(function(){
        $('#bloc-jams-modal').modal();
  });
});

$(document).ready(function(){
    $('.bloc-jams').hover(function(){
        $('.bloc-jams .text').slideToggle();
  });
});

$(document).ready(function(){
    $('.camp-chatter').click(function(){
        $('#camp-chatter-modal').modal();
  });
});

$(document).ready(function(){
    $('.camp-chatter').hover(function(){
        $('.camp-chatter .text').slideToggle();
  });
});

$(document).ready(function(){
    $('.bloccit').click(function(){
        $('#bloccit-modal').modal();
  });
});

$(document).ready(function(){
    $('.bloccit').hover(function(){
        $('.bloccit .text').slideToggle();
  });
});

$(document).ready(function(){
    $('.blocipedia').click(function(){
        $('#blocipedia-modal').modal();
  });
});

$(document).ready(function(){
    $('.blocipedia').hover(function(){
        $('.blocipedia .text').slideToggle();
  });
});
...
$(document).ready(function(){
    $('.alba').hover(function(){
        $('.alba .text').slideToggle();
  });
});

$(document).ready(function(){
    $('.rockefeller').click(function(){
        $('#rockefeller-modal').modal();
  });
});

$(document).ready(function(){
    $('.rockefeller').hover(function(){
        $('.rockefeller .text').slideToggle();
  });
});

$(document).ready(function(){
    $('.master-art').click(function(){
        $('#master-art-modal').modal();
  });
});
